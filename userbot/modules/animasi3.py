...
async def _(event):
    ...
    if input_str == "cinta":
        ...
        animation_chars = [
            "`Bersiap Untuk Mengirim Cintaku Ke Cizi Cantik😘`",
            "`Mencari Pintu Hatinya`",
            "`Mengirim Cintaku Ke Cizi.. 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 36%\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 52%\n█████████████▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 84%\n█████████████████████▒▒▒▒ `",
            "`Mengirim Cintaku Ke Cizi.. 100%\n█████████CINTAKU███████████ `",
            f"`Cintaku Sekarang Sepenuhnya Terkirim Ke Cizi Kawaiii😍, Dan Sekarang Aku Sangat Mencintai Mu Cizi🥰, I Love You Cizi 😘`"]
