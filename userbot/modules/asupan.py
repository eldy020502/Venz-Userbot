...
async def _(event):
    try:
        ...
        await event.edit("**Tidak bisa menemukan video haram.**")
...
async def _(event):
    try:
        ...
        await event.edit("**Tidak bisa menemukan video chika sexy.**")
...
async def _(event):
    try:
        ...
        await event.edit("**Tidak bisa menemukan video bocil haram.**")
