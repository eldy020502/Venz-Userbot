...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/eldy020502/Venz-Userbot"
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Venz-Userbot....`")
...
async def killdabot(event):
    await event.edit("`Restarting Venz-Userbot...`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[✨ Venz-Userbot Repo](https://github.com/eldy020502/Venz-Userbot/blob/Venz-Userbot/README.md)"
