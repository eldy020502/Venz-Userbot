...
import psutil
from userbot import ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, VENZ_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot, CMD_HANDLER as cmd
...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            "**⚜-**✨Venz-Userbot✨ Versi:** \n "
            f"heads/Venz-Userbot-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
@venz_cmd(pattern="(?:venzalive)\\s?(.)?")
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f" **✨venz-userbot✨** \n\n"
        f"\n__**{VENZ_TEKS_KUSTOM}**__\n\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━✠╮\n"
        f"◙ `Name       :` {DEFAULTUSER} \n"
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/justvenzzz) | [ᴄʜᴀɴɴᴇʟ](https://t.me/venzproject) | [ᴏᴡɴᴇʀ](https://t.me/moonscrsh) | [ɢɪᴛʜᴜʙ](https://github.com/eldy020502/Venz-Userbot)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
...
@venz_cmd(pattern="(?:venzon)\\s?(.)?")
async def amireallyalive(alive):
    await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬● \n"
        f"✾ 🤴 • `ᴏᴡɴᴇʀ    :`[El](t.me/moonscrsh) \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"┣  **GitHub   :** [el](https://github.com/eldy020502/Venz-Userbot) \n"
        f"┣  **Support  :** [Groups](https://t.me/venzproject) \n"
        f"┣  **Owner    :** [el](https://t.me/moonscrsh) \n"
        f"┗━━━━━━━━━━━━━━━━━━━━━")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
