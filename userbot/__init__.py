...
# KALO NGEFORK ID DEVS NYA GA USAH DI HAPUS YA KONCOL 😡
DEVS = (
    1663258664,
    1971311438,
    1416529201,
...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/e43056fdbf77c034618aa.jpg"
...
VENZ_TEKS_KUSTOM = os.environ.get("VENZ_TEKS_KUSTOM", "I'am Using Venz-Userbot✨")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/b4b0c2ad19e40f87cf98e.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/e43056fdbf77c034618aa.jpg"
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**venz-userbot Berhasil Diaktifkan✨**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @justvenzzz\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @venzproject \n━━━━━━━━━━━━━━━━━━━")
    return
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"°__Mengganti Teks Yang Ada Command venzAlive__.\n\n"
                    f"© @vnotv")
                await event.edit(
                    text,
                    file=kyylogo,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk venz Userbot, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @moonscrsh")
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [custom.Button.url(
                            "ʟɪᴄᴇɴsᴇ",
                            "https://github.com/eldy020502/Venz-Userbot/LICENSE")],
                    ],
                    link_preview=False,
                )
