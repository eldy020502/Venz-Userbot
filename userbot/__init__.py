...
from telethon.network.connection.tcpabridged import ConnectionTcApridged
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/f7fe73abb7d372b19aec3.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/f7fe73abb7d372b19aec3.jpg"
...
try:
    bot = TelegramClient(
        ...
        api_id=API_KEY,
        api_hash=API_HASH,
        connection=ConnectionTcAbridged
        auto_reconnect=True,
