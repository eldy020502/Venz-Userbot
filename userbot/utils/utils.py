...
async def autobot():
    ...
    if who.username:
        ...
        username = "venz" + (str(who.id))[5:] + "ubot"
    bf = "@BotFather"
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = "venz" + (str(who.id))[6:] + str(ran) + "ubot"
        await bot.send_message(bf, username)
        await asyncio.sleep(1)
        ...
        if nowdone.startswith("Done!"):
            ...
            await bot.send_message(bf, f"@{username}")
            await asyncio.sleep(1)
            await bot.send_file(bf, "resources/extras/IMG_20220314_195944_153.jpg")
            await asyncio.sleep(3)
            ...
            await bot(EditAdminRequest(int(BOTLOG_CHATID), f"@{username}", rights, "𝐀𝐒𝐒𝐈𝐒𝐓𝐀𝐍𝐓 𝐕𝐄𝐍𝐙"))
            kntl = "resources/extras/IMG_20220314_195944_153.jpg"
